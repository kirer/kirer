...
public class TravelViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TravelViewHolder(View itemView, FlowLayout itemTagContainer, ImageView itemCover, TextView itemTitle, RoundedImageView itemAvatar, TextView itemName, TextView itemCreateTime, TextView itemLikeCount) {
        super(itemView);
    ...
    public static TravelViewHolder newInstance(View itemView) {
        ...
        ImageView itemCover = (ImageView) itemView.findViewById(R.id.item_cover);
