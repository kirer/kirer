...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, DisplayUtil.dip2px(context,10));
        verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, DisplayUtil.dip2px(context,5));
